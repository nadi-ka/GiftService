...
//		filterParams.add(new FilterParam("tag", "Sport"));
//		orderParams.add(new OrderParam("date", "desc"));
//		
//		CertificateDaoSql certificateDao = getCertificateDao();
//		GiftCertificate certificate = certificateDao.findCertificates(filterParams, orderParams).get(0);
//		
//		assertTrue(certificate.getId() == 2);
//	}
	...
	private GiftCertificate getCertificate() {
		...
		LocalDateTime stamp = DateTimeFormatterISO.createAndformatDateTime();
